...
overcooked_config = {
    ...
    "behavior_weights": {
        agent_id: {
            "delivery_reward": 1,
            "delivery_act_reward": mug_globals.get("delivery_act_reward", 0),
            "onion_in_pot_reward": mug_globals.get("onion_in_pot_reward", 0),
            "soup_in_dish_reward": mug_globals.get("delivery_act_reward", 0),
        }
...
env = registry.make(
    "Overcooked-BehaviorFeatures-CoordinationRing-EnvToRender",
    render_mode="mug",
)
