"""Slime Volleyball: human vs. heuristic (Python code) policy.

Demonstrates deploying a heuristic policy into an experiment. The heuristic
is a HeuristicPolicy subclass implementing `compute_action(self, env,
agent_id)`, defined in examples/slime_volleyball/policies/ball_chaser.py.
The class itself is dropped into the policy mapping the same way ONNX
ModelConfig policies are (compare with slimevb_human_ai.py).
"""
...
from examples.slime_volleyball.policies.ball_chaser import BallChaser
...
start_scene = (
    ...
    .scene(
        scene_id="slimevb_heuristic_start_scene",
        experiment_config={},
    ...
    .display(
        ...
        scene_body=(
            ...
            "how to set up an experiment with a human playing against a heuristic "
            "(Python code) policy.",
        ),
    )
)
...
slime_scene = (
    gym_scene.GymScene()
    .scene(scene_id="slime_heuristic_gym_scene", experiment_config={})
...
end_scene = (
    ...
    .scene(scene_id="slimevb_heuristic_end_scene")
    .display(
...
if __name__ == "__main__":
    ...
    experiment_config = (
        ...
        .experiment(stager=stager, experiment_id="slime_vb_heuristic_demo")
