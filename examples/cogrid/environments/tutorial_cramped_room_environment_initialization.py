"""Tutorial Cramped Room environment initialization for CoGrid 0.2.1.

Single-agent tutorial environment. This file is executed by Pyodide
to create the environment. It must produce an ``env`` variable at module scope.
"""
...
registry.register(
    environment_id="Overcooked-CrampedRoom-Tutorial-MUG",
    env_class=functools.partial(OvercookedEnv, config=overcooked_config),
)

env = registry.make("Overcooked-CrampedRoom-Tutorial-MUG", render_mode="mug")
