...
| Feature | Details |
|---------|---------|
| **Execution Mode** | Pyodide or Server (flexible) |
| **Players** | Human vs AI opponent |
| **Environment** | Custom SlimeVolley environment |
| **AI Policy** | ONNX neural network |
| **Rendering** | Circles, Polygons, Lines with depth ordering |
| **Input** | Arrow keys with diagonal combinations |
