...
- [ ] **Phase 87: ConfirmedFrame-Based Resource Management** - Replace hardcoded snapshot and input buffer limits with confirmedFrame-driven pruning, add snapshotInterval config
