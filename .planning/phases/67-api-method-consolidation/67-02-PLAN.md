...
must_haves:
  truths:
    ...
    - "The existing rendering() method is UNCHANGED and still accepts all 14 params including asset params. A new assets() method exists as an additional way to set the 5 asset-related attributes (preload_specs, assets_dir, assets_to_preload, animation_configs, state_init). Phase 68 will remove asset params from rendering()."
